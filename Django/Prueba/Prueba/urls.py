...
from personas.views import pag1
from personas.views import despedida
from personas.views import bienvenida
from personas.views import detallePersona

urlpatterns = [
    path('admin/', admin.site.urls),
    path('hi/', bienvenida), # Llamando a la página proncipal como index
    path("bye/", despedida),
